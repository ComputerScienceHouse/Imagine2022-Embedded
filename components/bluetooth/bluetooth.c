...
void update_device_info(esp_bt_gap_cb_param_t *param)
{
    ...
    ESP_LOGI(BT_TAG, "Found a target device, address %s, name %s, RSSI %d, TIMESTAMP %d", bda2str(param->disc_res.bda, bda_str, 18), p_dev->bdname, rssi, wifi_connected() ? (int) now : -1);
